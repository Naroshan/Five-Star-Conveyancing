...
export function WhatsAppIcon({ size, color = "currentColor", className }: IconProps) {
  return (
    <Svg size={size} className={className}>
      <path
        d="M12 3.2c-4.9 0-8.8 4-8.8 8.8 0 1.6.4 3.1 1.2 4.4L3.2 20.8l4.6-1.2c1.3.7 2.7 1.1 4.2 1.1 4.9 0 8.8-4 8.8-8.8s-3.9-8.7-8.8-8.7Zm4.9 12.5c-.2.6-1.2 1.1-1.7 1.2-.4.1-1 .1-1.6-.1-.4-.1-.9-.3-1.5-.5-2.6-1.1-4.3-3.8-4.4-4-.1-.2-1-1.3-1-2.5s.6-1.8.9-2c.2-.2.5-.3.7-.3h.5c.2 0 .4 0 .5.4.2.5.7 1.6.7 1.8.1.1.1.3 0 .4-.1.2-.1.3-.3.4-.1.2-.3.3-.4.5-.1.1-.3.3-.1.6.2.3.8 1.4 1.8 2.2 1.2 1.1 2.2 1.4 2.6 1.6.3.1.5.1.7-.1.2-.2.7-.8 1-1.1.2-.2.4-.2.7-.1l1.6.8c.2.1.4.2.4.3.1.2.1.9-.1 1.5Z"
        fill={color}
      />
    </Svg>
  );
