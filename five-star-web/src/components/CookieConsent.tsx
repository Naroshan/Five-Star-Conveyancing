...
gtag('config', 'GT-5MCNDKRF');`}
          ...
          {/* LiveChat widget — license 19914263. Not loaded for a visitor
              outside England & Wales: it's a live conversion channel like
              the quote forms and phone/WhatsApp links, so it's withheld the
              same way — see useRegionRestriction.ts. */}
          {!regionRestricted && (
            <>
