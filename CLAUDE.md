...
`quote-engine/five-star-conveyancing-quote-engine-0.3.0.tgz` (built from
...
```bash
npm install
npm install ../quote-engine/five-star-conveyancing-quote-engine-0.3.0.tgz  # re-run after rebuilding the tarball
...
`file:../quote-engine/five-star-conveyancing-quote-engine-0.3.0.tgz`.
...
cd ../five-star-web && npm install ../quote-engine/five-star-conveyancing-quote-engine-0.3.0.tgz
```
